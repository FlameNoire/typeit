      ...
      var f = function(t) {
          var e = (function(t) {
              ...
              return (
                n.forEach(function(e) {
                  ...
                  t = t.replace(new RegExp("".concat(n, "/?>"), "i"), c);
                }),
                { string: t, nodes: n }
              );
            })(t),
          ...
          return (
            r.forEach(function(t, e) {
              if (r.slice(e, e + 3).join("") === c) {
                r.splice(e, 3);
                var n = e,
                  o = i.shift(),
                  s = o.innerHTML.split(""),
                  a = [].slice.call(o.attributes).map(function(t) {
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function() {
                return (
                  (this.waiting = d(this.executed).concat(d(this.waiting))),
                  (this.executed = []),
                  this
                );
              }
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: "maybeNoderize",
                value: function(t) {
                  return this.opts.html ? f(t) : t.split("");
                }
              },
              {
                key: "queueString",
