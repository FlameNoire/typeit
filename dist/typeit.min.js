      ...
      var h = function(t) {
          var e = (function(t) {
              ...
              return (
                (n = n.filter(function(e) {
                  ...
                  var n = e.outerHTML.slice(0, -1);
                  t = t.replace(new RegExp("".concat(n, "/?>"), "i"), f);
                }),
                { string: t, nodes: n }
              );
            })(t),
          ...
          return (
            r.forEach(function(t, e) {
              if (r.slice(e, e + 3).join("") === f) {
                var n = e,
                  s = i.shift(),
                  u = s.innerHTML.split(""),
                  a = [].slice.call(s.attributes).map(function(t) {
                ...
                u.length
                  ? u.forEach(function(t, i) {
                      o.push({
                        ...
                        isLastCharacter: i + 1 === u.length
                      }),
                        n++;
                    })
                  : o.push({ tag: s.tagName, attributes: a, content: null });
              } else o.push(t);
            }),
            (o = (function(t) {
              for (var e = !0; e; )
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function() {
                return (
                  (this.waiting = v(this.executed).concat(v(this.waiting))),
                  (this.executed = []),
                  this
                );
              }
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: "maybeNoderize",
                value: function(t) {
                  return this.opts.html ? h(t) : t.split("");
                }
              },
              {
                key: "queueString",
                ...
                value: function(t) {
                  return (
                    ...
                    (this.opts.startDelete
                      ...
                      : void (this.opts.strings = m(l(t.trim())).concat(
                          m(this.opts.strings)
                        )))
                  );
                }
                      ...
                      return (
                        ...
                        (i = (function(t) {
                          return (t = t.map(function(e, n) {
                            if ("object" === y(e) && e.isFirstCharacter) {
      ...
      var j = (function() {
        function t(e, n) {
          !(function(t, e) {
            ...
            (this.instances = q(e).map(function(t) {
              return new S({
                element: t,
                id: Math.random()
                  .toString(36)
