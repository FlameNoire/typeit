        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "reset",
              value: function() {
                (this.waiting = f(this.executed).concat(f(this.waiting))),
                  (this.executed = []);
              }
            }
          ]) && p(e.prototype, n),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  try {
                    for (
                      var s,
                        a = function() {
                          var e = s.value,
                            i = [e, t.queue, t.typeit];
                          n = n
                            .then(function() {
                              return new Promise(function(n, r) {
                                if (t.status.frozen) return r();
                                var o, s;
                                (t.setPace(),
                                e[2] && e[2].isFirst && t.opts.beforeString) &&
                                  (o = t.opts).beforeString.apply(o, i);
                                t.opts.beforeStep &&
                                  (s = t.opts).beforeStep.apply(s, i);
                                e[0].call(t, e[1], e[2]).then(function() {
                                  var r, o;
                                  e[2] &&
                                    e[2].isLast &&
                                    t.opts.afterString &&
                                    (r = t.opts).afterString.apply(r, i);
                                  t.opts.afterStep &&
                                    (o = t.opts).afterStep.apply(o, i);
                                  t.queue.executed.push(
                                    t.queue.waiting.shift()
                                  ),
                                    n();
                                });
                              });
                  ...
                  if (this.opts.loop) {
                    var l = this.opts.loopDelay
                      ? this.opts.loopDelay
                      : this.opts.nextStringDelay;
                    this.wait(function() {
                      (t.queue = []),
                        t.queueDeletions(t.contents()),
                        t.generateQueue([t.pause, l.before]),
                        t.fire();
                    }, l.after);
                  }
      ...
      var S = (function() {
        function t(e, n) {
          ...
          !(function(t, e) {
            ...
            (this.instances = w(e).map(function(t) {
              return new m({
                element: t,
                id: Math.random()
                  .toString(36)
